riot.tag2('gauge', '<div class="power-gauge"><h2>{opts.title}</h2></div>', 'gauge .power-gauge g.arc,[data-is="gauge"] .power-gauge g.arc{ fill: steelblue; } gauge .power-gauge g.pointer,[data-is="gauge"] .power-gauge g.pointer{ fill: #999; stroke: #666; } gauge .power-gauge g.label text,[data-is="gauge"] .power-gauge g.label text{ text-anchor: middle; font-size: 14px; font-weight: bold; fill: #666; }', '', function(opts) {
